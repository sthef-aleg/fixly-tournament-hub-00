...
const CreateWizard = () => {
  ...
  const isStepValid = () => {
    switch (currentStep) {
      case 1:
        return formData.name.trim() !== "" && formData.sport.trim() !== "";
      case 2:
        return true;
      case 3:
        return formData.teams.filter((t) => t.name.trim() !== "").length >= 2;
      default:
        return false;
    }
  };
        ...
        {currentStep === 1 && (
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                id="sport"
                placeholder="Ej: Fútbol, Básquet, Voleibol..."
            ...
            <div className="space-y-3">
              ...
              <RadioGroup
                value={formData.mode}
                onValueChange={(value: TournamentMode) =>
                  updateFormData({ mode: value })
                }
              ...
              >
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Cualquiera puede editar resultados. Ideal para grupos de amigos.
                    </p>
                  </div>
                </Label>
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Solo tú puedes editar. Control total como administrador.
                    </p>
                  </div>
                </Label>
              </RadioGroup>
            ...
            >
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground">
                    Todos contra todos. Cada equipo juega contra cada rival. 
                    Sistema de puntos con tabla de posiciones.
                  </p>
                </div>
              </Label>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground">
                    Formato mata-mata. El perdedor queda eliminado. 
                    Llaves (brackets) hasta la final.
                  </p>
                </div>
              </Label>
            </RadioGroup>
            ...
            {formData.teams.length % 2 !== 0 && (
              <div className="p-4 rounded-lg bg-accent/10 border border-accent/20">
                <p className="text-sm text-accent font-medium">
                  ⚡ Número impar de equipos: Se asignará una "Fecha Libre" automáticamente en cada jornada.
                </p>
              </div>
            )}
          </div>
